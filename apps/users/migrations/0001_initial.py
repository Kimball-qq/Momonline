    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slideshow', models.ImageField(upload_to='banner/%Y%m', verbose_name='轮播图')),
                ('url', models.URLField(verbose_name='访问地址')),
                ('sort_order', models.IntegerField(default=100, verbose_name='顺序')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('man', '男'), ('woman', '女')], default='man', max_length=10, verbose_name='性别')),
                ...
                ('head_portrait', models.ImageField(default='image/default.png', upload_to='image/%Y%m')),
