...
function submit_comment(){
	...
	$('#release_com').click(function(){
		...
		uid = $('#use_id').val();
		com_id= ajax_submit_comment(comment,lession_id,parent_id,child_uid);
		getopage(1,com_id);
	...
	$('.reply').live("click",function(){
		...
		ajax_submit_comment(comment,lession_id,parent_id,child_uid);
...
function ajax_submit_comment(comment,lession_id,parent_id,child_uid){
	var p_id = "";
	...
	$.ajax({
		    ...
		    data:{comment:comment,parent_id:parent_id,lession_id:lession_id,child_uid:child_uid},
...
function page_commment(page){
    ...
    $.ajax({
            type: "get",
            url:'/lession/comment/?lessionid='+lession_id+'&page='+page,
            async: true,
            success: function(data) {
            	data = $.trim(data);
            	if(data){
